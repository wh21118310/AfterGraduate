...
class ISBI_Loader(Dataset):
    def __init__(self,datapath):
        ...
        self.imgs_path = glob.glob(os.path.join(datapath,'image/*.png'))
...
if __name__ == '__main__':
    isbi_dataset = ISBI_Loader("../sardata/train")
    print("数据个数: ",len(isbi_dataset))
    train_loader = torch.utils.data.DataLoader(dataset=isbi_dataset,batch_size=2)
